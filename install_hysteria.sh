...
安装模式:
  $0 [--port PORT] [--password PASS]  # 传统安装方式
  $0 install [--port PORT] [--password PASS]
...
参数说明:
  ...
  --password PASS  认证密码 (默认: 随机生成)

示例:
  # 传统安装方式
  $0 --port 443 --password mypass
...
install_hysteria() {
  ...
  # 下载二进制
  info "下载Hysteria v${HYSTERIA_VERSION}..."
